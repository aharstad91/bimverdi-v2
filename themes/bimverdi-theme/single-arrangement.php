...
<div class="min-h-screen bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <?php
        // Ressurs-rig: samme oversiktsmatrise som temagruppe-siden, drevet av
        // arrangementets temagruppe(r) (union). Ekskluderer dette arrangementet
        // fra Arrangementer-blokken. Skjules helt hvis ingen temagruppe/innhold.
        // Jf. Teams 22.06 + docs/plans/2026-06-22-001-...
        if (!empty($temagrupper) && function_exists('bv_ressurs_rig_render')) {
            bv_ressurs_rig_render($temagrupper, ['exclude_event_id' => $arrangement_id]);
        }
        ?>
