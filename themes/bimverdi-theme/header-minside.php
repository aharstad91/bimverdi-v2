...
<nav class="bg-white border-b border-[#E7E5E4]">
    <div class="max-w-7xl mx-auto px-6">
        <div class="flex items-center justify-between h-12">
            ...
            <div class="flex items-center h-6 border-l border-[#E7E5E4] pl-4">
                <a href="<?php echo esc_url(bimverdi_minside_url('profil')); ?>" 
                   class="flex items-center gap-2 text-sm font-medium <?php echo bimverdi_is_minside_route(['profil', 'foretak']) ? 'text-[#F97316]' : 'text-[#111827] hover:text-[#57534E]'; ?> transition-colors">
                    Min konto
