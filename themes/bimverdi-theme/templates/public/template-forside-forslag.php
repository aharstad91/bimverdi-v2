<?php
/**
 * Template Name: Forside – forslag (uke 38)
 *
 * KOPI av front-page.php, ikke en erstatning. Ligger som egen sidemal slik at
 * forslaget kan vises på en egen URL mens dagens forside står urørt, til Bård
 * og Andreas har sett på det.
 *
 * Endret mot originalen, etter Trello #352 og synken 15.09:
 *  1. Nettverks-SVG-en i heroen er byttet mot neste arrangement og siste
 *     artikkel — det Bård ba om da han sa at forsiden ser lik ut hver gang.
 *  2. Arrangementskortet i kortraden er borte (det står nå øverst), og plassen
 *     er tatt av et kort for den dynamiske tema-grafen.
 * Resten av siden er uendret.
 */
