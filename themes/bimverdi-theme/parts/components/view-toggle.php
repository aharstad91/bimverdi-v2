...
function bimverdi_view_toggle($args = []) {
    ...
    ?>
    <div class="bv-view-toggle hidden md:flex items-center bg-[#F5F5F4] rounded-lg p-0.5"
        ...
        <button type="button"
                class="bv-view-toggle__btn bv-view-toggle__btn--grid bg-white text-[#111827] shadow-sm px-2.5 py-2 rounded-md transition-all"
        ...
        <button type="button"
                class="bv-view-toggle__btn bv-view-toggle__btn--list text-[#57534E] px-2.5 py-2 rounded-md transition-all"
