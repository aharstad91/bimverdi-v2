...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-12">
        <h2 class="text-lg font-semibold text-[#111827] mb-6">Verktøydetaljer</h2>
    ...
    <div class="mb-12">
        <h3 class="text-sm font-semibold text-[#111827] uppercase tracking-wider mb-6">Om verktøyregistrering</h3>
        ...
        <div class="space-y-4">
            <div class="flex gap-3 items-start">
                ...
                <div>
                    <p class="font-medium text-[#111827]">Registrer verktøy</p>
                    <p class="text-sm text-[#57534E] mt-0.5">Legg til programvare, plugins eller andre ressurser</p>
                </div>
            </div>
            ...
            <div class="flex gap-3 items-start">
                ...
                <div>
                    <p class="font-medium text-[#111827]">Synlig for alle deltakere</p>
                    <p class="text-sm text-[#57534E] mt-0.5">Verktøyet vises i den felles verktøykatalogen</p>
                </div>
            </div>
            ...
            <div class="flex gap-3 items-start">
                ...
                <div>
                    <p class="font-medium text-[#111827]">Legg til detaljer</p>
                    <p class="text-sm text-[#57534E] mt-0.5">Beskrivelse, lenke og hvilke plattformer som støttes</p>
                </div>
            </div>
            ...
            <div class="flex gap-3 items-start">
                ...
                <div>
                    ...
                    <p class="text-sm text-[#57534E] mt-0.5">Rediger eller slett verktøy når som helst</p>
                </div>
            </div>
        </div>
    </div>
