...
<div class="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-start gap-3">
    ...
    <p class="text-green-800 text-sm"><?php _e('Kunnskapskilden er registrert!', 'bimverdi'); ?></p>
</div>
<?php endif; ?>
...
<div class="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-start gap-3">
    ...
    <p class="text-green-800 text-sm"><?php _e('Kunnskapskilden er oppdatert!', 'bimverdi'); ?></p>
</div>
<?php endif; ?>
