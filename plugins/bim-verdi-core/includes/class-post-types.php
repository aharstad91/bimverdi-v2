...
class BIM_Verdi_Post_Types {
    ...
    /**
     * Register Kunnskapskilde CPT (Knowledge Sources)
     */
    private function register_kunnskapskilde() {
        $labels = array(
            'name'                  => _x('Kunnskapskilder', 'Post Type General Name', 'bim-verdi-core'),
            'singular_name'         => _x('Kunnskapskilde', 'Post Type Singular Name', 'bim-verdi-core'),
            'menu_name'             => __('Kunnskapskilder', 'bim-verdi-core'),
            'all_items'             => __('Alle kunnskapskilder', 'bim-verdi-core'),
            'add_new_item'          => __('Legg til ny kunnskapskilde', 'bim-verdi-core'),
            'edit_item'             => __('Rediger kunnskapskilde', 'bim-verdi-core'),
            'view_item'             => __('Vis kunnskapskilde', 'bim-verdi-core'),
            'search_items'          => __('Søk kunnskapskilder', 'bim-verdi-core'),
            'not_found'             => __('Ingen kunnskapskilder funnet', 'bim-verdi-core'),
        );
        ...
        $args = array(
            ...
            'has_archive'           => true,
            'rewrite'               => array('slug' => 'kunnskapskilder'),
            'capability_type'       => 'post',
            'show_in_rest'          => true,
        );

        register_post_type('kunnskapskilde', $args);
    }
